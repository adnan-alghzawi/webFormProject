...
<body>
           ...
           <section class="service" id="service">
              <div class="section__container service__container">
                <div class="service__content">
                  ...
                  <h2 class="section__header">Empowering Your Academic Journey!</h2>
                  <ul class="service__list">
                    <li>
                      <span><i class="ri-book-2-line"></i></span>
                      Extensive Digital & Physical Book Collection
                    </li>
                    <li>
                      <span><i class="ri-calendar-check-line"></i></span>
                      Seamless Room Reservation System
                    </li>
                    <li>
    ...
    <section class="section__container banner__container">
        ...
        <div class="banner__card">
            <h4>500+</h4>
            <p>Study Room Reservations Completed</p>
        </div>
        <div class="banner__card">
            <h4>1,000+</h4>
            <p>Happy Students & Faculty Members</p>
        </div>
        </div>
    </section>
